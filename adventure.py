...
right_left = input("You're at a cross road. Where do you want to go?\nType \"left\" or \"right\"\n")
...
#Learned if and elif statements to create a choose your own adventure game. 
